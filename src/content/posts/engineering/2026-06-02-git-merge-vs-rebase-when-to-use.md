...
author: "BLOA Team"
date: "2026-06-02"
summary: "Git merge와 rebase 중 무엇을 쓸지 헷갈릴 때 판단 기준을 정리했다. 둘의 차이, 협업에서 절대 하면 안 되는 rebase, 상황별 선택 기준과 충돌 대처까지 실무 기준으로 다룬다."
oneLineSummary: "Git merge와 rebase 중 무엇을 쓸지, 협업에서 어디까지 안전한지 판단 기준을 정리했다."
tags: [Git, GitHub, tip]
status: "published"
---
...
> 요약 박스
>
> - merge는 히스토리를 그대로 보존하고, rebase는 커밋을 다시 써서 일직선으로 만듭니다.
> - 혼자 쓰는 로컬 브랜치는 rebase로 정리해도 안전합니다.
> - 이미 push해서 남이 볼 수 있는 커밋은 rebase하지 않습니다. 이게 rebase의 황금률입니다. (출처: [Pro Git - Rebasing](https://git-scm.com/book/en/v2/Git-Branching-Rebasing))

최종 업데이트: 2026-06-02

## 작성 관점

저는 팀 작업에서 가장 많이 본 사고가 "히스토리를 예쁘게 만들려다 남의 작업을 날린 경우"라고 봅니다. 그래서 이 글은 "어느 쪽이 더 멋진가"가 아니라 "어느 쪽이 사고를 안 내는가"를 기준으로 정리했습니다.
