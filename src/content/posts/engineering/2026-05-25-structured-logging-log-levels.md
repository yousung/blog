...
![여러 서비스 단계를 왼쪽에서 오른쪽으로 가로지르며, 흩어져 있는 수많은 로그 중 하나의 요청에 속한 로그만을 밝은 선 하나가 골라 이어 붙이고, 그 선이 마지막에 유독 두드러진 한 지점으로 이어지는 흐름을 형태로 표현한 도식](/images/posts/structured-logging-log-levels/figure.png)
