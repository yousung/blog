...
![달력의 한 날짜 칸 가운데 놓인 값이 변환 흐름을 타고 왼쪽으로 밀려 굵은 자정 경계선을 넘어 전날 칸으로 반쯤 떨어져 걸치는 모습을 형태로만 표현한 도식. 날짜만 의미 있는 값을 시각처럼 변환했을 때 하루가 뒤로 밀리는 실패를 보여준다.](/images/posts/timezone-utc-handling/figure.png)
