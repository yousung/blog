...
![파일을 뒤 레이어에서 지우면 앞 레이어에 그대로 남아 전체 높이가 줄지 않는 왼쪽 층 더미와, 같은 레이어 안에서 만들고 지워 높이가 낮아진 오른쪽 층 더미를 나란히 놓아 대비한 도식.](/images/posts/docker-image-size-checklist/figure.png)
