...
개발서 구매는 최신 유행보다 지금 내 코드에 적용할 수 있는지가 중요합니다. 이 글은 쿠팡 도서/음반 카테고리에서 확인한 `리팩토링 - 코드 구조를 체계적으로 개선하여 효율적인 리팩터링 구현하기 (2판)`을 기준으로, 책 소개와 개발자 독서 관점에서 구매 전 볼 점을 정리했습니다.
...
![리팩토링 2판 도서 표지 이미지](/images/posts/coupang/refactoring-2-javascript-secondary.jpg)
...
![리팩토링 2판 도서 표지 디테일](/images/posts/coupang/refactoring-2-javascript-detail.jpg)
