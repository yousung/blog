...
> **짧게 보면**
>
> - 2026년 6월 18일 확인 시점 쿠팡 판매가는 60,880원으로 보였습니다.
> - 상품 페이지에는 8,073개 상품평과 한 달 2,000명 이상 구매 표시가 있었습니다.
...
출력 결과에 대한 만족도도 높은 편입니다. 2026년 6월 18일 기준 상품 페이지의 상품평은 `최고` 88%, `좋음` 9%로 긍정 평가가 대부분이었습니다. 매장 재고통과 소분 날짜를 정리하거나, 카페 원두와 시럽을 구분하거나, 아이 학용품과 주방 수납함에 이름을 붙이는 식의 사용 장면이 많이 보입니다. 구매자들이 좋게 보는 지점은 글씨가 선명하게 나온다는 점, 접착력이 괜찮다는 점, 주방통이나 수납함에 붙였을 때 정돈된 느낌이 난다는 점입니다.
...
두 번째는 테이프 여백입니다. 라벨을 한 장씩 뽑으면 앞부분에 여백이 생겨 테이프가 아깝게 느껴질 수 있습니다. 처음 들어 있는 테스트 라벨도 이것저것 뽑아보면 금방 줄어든다는 이야기가 보여서, 여러 문구를 이어서 출력한 뒤 잘라 쓰거나 리필 테이프를 같이 보는 편이 현실적입니다.
...
네 번째는 블루투스 앱 연동이 아니라는 점입니다. 휴대폰에서 글꼴과 이미지를 편집하고 바로 보내는 경험을 기대했다면 맞지 않을 수 있습니다. 대량으로 빠르게 뽑아야 하는 환경에서는 출력 속도와 본체 입력 방식도 답답하게 느껴질 수 있습니다. 대신 본체만으로 바로 출력하는 단순함을 장점으로 받아들일 수 있는지가 선택 기준이 됩니다.
...
<div style="text-align: center; margin: 2rem 0 0.75rem;">
  <a href="https://link.coupang.com/a/eF034FFJKe" rel="nofollow sponsored noopener" style="display: inline-block; padding: 0.85rem 1.25rem; border-radius: 999px; background: #f97316; color: #fff; font-weight: 700; text-decoration: none; box-shadow: 0 8px 20px rgba(249, 115, 22, 0.22);">
