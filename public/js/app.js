...
try {
    ...
    $.fileOnLoad = function (src, pro, fileSize) {
        ...
        $myForm = $("#myForm");
        $myFile = $('#myFile');
        var originalImage = $(src).attr('src');
...
/***/ "./resources/assets/sass/font.scss":
/***/ (function(module, exports) {
...
__webpack_require__("./resources/assets/scss/login.scss");
module.exports = __webpack_require__("./resources/assets/sass/font.scss");
